...
import com.francisumeanozie.baymax.BaymaxApplication;
 ...
 */
public class CustomFontCurrencyEditText extends AppCompatEditText {
    private static String prefix = ""; //change to NGN, USD if need be
    ...
    public CustomFontCurrencyEditText(Context context) {
        this(context, null);
    }

    public CustomFontCurrencyEditText(Context context, AttributeSet attrs) {
        this(context, attrs, androidx.appcompat.R.attr.editTextStyle);

//        TypedArray array = context.getTheme().obtainStyledAttributes(
//                attrs,
//                R.styleable.Customcom_unionbk_marcus_customfonts_CustomFontsView,
//                0, 0);
//        try {
//            typefaceType = array.getInteger(R.styleable.Customcom_unionbk_marcus_customfonts_CustomFontsView_font_name,0);
//        }finally {
//            array.recycle();
//        }
//        if(!isInEditMode()){
//            setTypeface(BaymaxApplication.getApp().getTypeFace(typefaceType));
//        }
    }

    public CustomFontCurrencyEditText(Context context, AttributeSet attrs, int defStyleAttr) {
